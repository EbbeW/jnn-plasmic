...
import sty from "./PlasmicButton.module.css"; // plasmic-import: xenWMAt9fjgb/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 3WzvOlcGA_yI/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: DkKrfBfnBp4M/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__kTinN)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg__tb9U)}
                role={"img"}
              />
            ),
