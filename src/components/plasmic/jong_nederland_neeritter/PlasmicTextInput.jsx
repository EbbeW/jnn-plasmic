...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 44Bs5c9YUTWl/css
import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: QhC-OreqtXSJ/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 3WzvOlcGA_yI/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg___1YZt9)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <IconIcon
              className={classNames(projectcss.all, sty.svg__vbhm0)}
              role={"img"}
            />
          ),
