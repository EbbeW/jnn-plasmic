...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: ASsMdTjUegt9/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Y4goiaYc4-rB/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___6Ac7Q)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__u6Fn6)}
              />
            </React.Fragment>
          ),
